...
class WeatherList extends Component{
	...
	renderChart(data){
		...
		var day_5 = kelvinToC(data.list[34].main.temp);
		...
		var day_5_date = moment(data.list[34].dt * 1000).format("D");
		...
		var day_5_week = moment(data.list[34].dt * 1000).format("ddd");
		...
		var day_5_desc = data.list[34].weather[0].description;
		...
		var day_5_label = moment(data.list[34].dt * 1000).format("ddd, D");
